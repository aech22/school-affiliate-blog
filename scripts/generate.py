...
{"description":"この記事だけの要約。全角90〜120字。この記事を探している人が使う言葉を含める（サイト全体の説明にしない）","intro":"導入3〜4文","body":"Markdown本文。H2(##)を3〜5個。各H2の下は2〜4段落","outro":"まとめ3〜4文","items":[{"pros":["...","...","..."],"cons":"...","target":"..."}]}"""
